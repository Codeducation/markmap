...
import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, L as stores$1, o as onMount, I as onDestroy, t as track, e as element, k as claim_element, l as children, h as detach_dev, r as attr_dev, p as add_location, u as insert_dev, y as listen_dev, X as prop_dev, b as binding_callbacks, a as bind, c as space, f as text, g as create_component, q as query_selector_all, j as claim_space, m as claim_text, n as claim_component, P as set_style, w as append_dev, x as mount_component, Y as prevent_default, z as add_flush_callback, A as transition_in, B as transition_out, C as destroy_component, Z as run_all, H as globals, T as set_data_dev, K as noop } from './client.0657c982.js';
import { M as Markmap_1, a as lodash_debounce, b as browser } from './markmap.3ee509cb.js';
import { F as Footer } from './footer.35279741.js';
import { T as Toolbar_1, p as parseURL, a as swal, s as subscribeHash, l as loadData } from './loader.065bbd34.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 161, 10, 4612);
			...
			add_location(input, file, 165, 10, 4831);
			attr_dev(a0, "class", "ml-2 no-underline");
			add_location(a0, file, 166, 10, 4979);
			attr_dev(a1, "class", "ml-2 no-underline");
			add_location(a1, file, 167, 10, 5071);
			attr_dev(a2, "class", "ml-2 no-underline");
			add_location(a2, file, 168, 10, 5165);
			attr_dev(form, "class", "flex");
			add_location(form, file, 160, 8, 4541);
			attr_dev(div, "class", "md:flex w-full");
			add_location(div, file, 159, 6, 4504);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(a, file, 157, 6, 4429);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 163, 12, 4710);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(163:10) {#if payload.info.type}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 171, 10, 5294);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(textarea, file, 179, 6, 5536);
		},
		m: function mount(target, anchor) {
...
`;
	...
	onMount(async () => {
		...
		const { default: CodeMirror } = await Promise.all([import('./codemirror.14d3f224.js'), __inject_styles(["client-ff2bd8be.css","codemirror-8033c53c.css"])]).then(function(x) { return x[0]; });
